...
public class SearchFacadeTestSuite {
    ...
    @Test
    public void shouldFindMultipleEmployees() {
    ...
    @Test
    public void shouldReturnEmptyStringForNonExistingString() {
        Employee johnSmith = new Employee("John", "Smith");
        Employee stephanieClarckson = new Employee("Stephanie", "Clarckson");
        Employee lindaKovalsky = new Employee("Linda", "Kovalsky");
    ...
    public void shouldThrowNullPointerExceptionForNullInput() {
        ...
        List<Company> companies = searchFacade.findCompaniesContaining(null);
    }
}
